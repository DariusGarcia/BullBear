					...
					<section className='flex flex-col h-screen md:h-1/2 md:w-3/4 md:mb-1'>
						<form
							...
							<input
								...
								autoFocus
							/>
							<button className='w-3/5 md:w-auto text-sm p-4 flex text-center justify-center bg-lightBlue rounded-md mb-6 md:mb-12 md:mb-0'>
								Search Ticker
							</button>
						</form>
						<div className='relative h-screen md:h-96 overflow-scroll md:overflow-hidden w-max md:w-full bg-secondary shadow-3xl rounded-xl '>
							<article className='h-96 md:h-96 w-max md:w-full pb-2 p-4 bg-secondary rounded-xl shadow-3xl overflow-auto'>
								<nav className='flex items-center h-12 bg-grey rounded-xl w-full px-2 md:px-0 '>
									<ul className='flex w-full justify-between  '>
										<span className='w-1/6'>
											<li className='text-xs md:text-lg w-max border-b-2 pb-1'>
												Stock
											</li>
										</span>
										<span className='w-1/6'>
										...
										<span className='w-1/6 mx-4'>
											<li className='text-xs md:text-lg w-max border-b-2 pb-1'>
												24hr Change
											</li>
										</span>
										<span className='w-1/6'>
											<li className='text-xs md:text-lg w-max border-b-2 mr-2 md:mr-0 pb-1'>
												Volume
											</li>
										</span>
										<span className='w-1/6'>
											<li className='text-xs md:text-lg w-max border-b-2 pb-1 ml-2 md:ml-0'>
												Last Trading Day
											</li>
										</span>
									</ul>
