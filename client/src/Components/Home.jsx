...
export default function Home() {
	...
	if (toggle) {
		info = (
			<>
				<div className='flex justify-evenly h-auto w-full overflow-x-scroll md:overflow-x-auto items-center mt-12 md:mt-0  bg-grey '>
					<div className='flex flex-col md:flex-row md:justify-evenly lg:mx-12'>
						...
						<section className='flex flex-col h-screen md:h-1/2 md:w-full md:mr-4 md:mb-1'>
							<form
								className='flex flex-col md:flex-row w-full h-max md:h-24 md:items-end md:mb-3 pl-4 md:pl-0 md:gap-8 justify-start md:justify-between  px-1 md:px-0'
								...
								<article className='h-96 md:h-96 w-full md:w-full pb-2 py-4 px-0 md:px-4 md:p-4 bg-secondary rounded-xl shadow-3xl overflow-auto'>
									<nav className=' h-12 bg-grey rounded-xl w-full md:w-full mx-3 md:mx-0 md:px-0 '>
										<ul className='grid grid-cols-5 self-center  h-full md:px-0 px-2 '>
											...
											<span className=''>
												<li className='hidden md:flex text-xs md:text-base w-1/7 h-full font-semibold items-center '>
													Name
												</li>
											</span>
											<span className=''>
				...
				<div className='flex justify-evenly h-auto w-full overflow-x-scroll md:overflow-x-auto  items-center mt-12 md:mt-0  bg-grey '>
					<div className='flex flex-col md:flex-row md:justify-evenly lg:mx-12'>
						...
						<section className='flex flex-col h-screen md:h-1/2 md:w-full md:mr-4 md:mb-1'>
							...
							{/*----------------------- ticker info ----------------------- */}
							<div className='relative h-auto overflow-scroll md:overflow-hidden w-max md:w-full bg-secondary shadow-3xl rounded-xl '>
								<article className='h-96 md:h-96 w-full md:w-full pb-2 py-4 px-0 md:px-4 md:p-4 bg-secondary rounded-xl shadow-3xl overflow-auto'>
									<nav className=' h-12 bg-grey rounded-xl w-full md:w-full mx-3 md:mx-0 md:px-0 '>
										<ul className='grid grid-cols-5 self-center  h-full md:px-0 px-2 '>
											<span className=' md:pl-2'>
									...
									<div onClick={handleOnClick} className='overflow-auto '>
										{ticker.map((enteredTicker) => (
											<FetchStocks
												name={enteredTicker}
												toggle={toggle}
